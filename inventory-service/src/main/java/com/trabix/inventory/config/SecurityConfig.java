package com.trabix.inventory.config;

import com.trabix.inventory.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Cuadre solo admin
                .requestMatchers(HttpMethod.POST, "/tandas/*/iniciar-cuadre").hasRole("ADMIN")
